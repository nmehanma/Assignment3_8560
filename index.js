...
const checkRegex = (userInput, regex) => {  // the test succeded a false negative or false positive,think backwards if case true, the if condition has to be false to bypass the error thrown
